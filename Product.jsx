...
import techstars from '../assets/techstars-asi.png';
import awe from '../assets/awe-asi.png';
import breakthrough from '../assets/breakthrough-asi.png';
...
function Product() {
  ...
  const handleScroll = () => {
    ...
    const videoContainer = heroRef.current;
  ...
  const observers = {
    ...
    heroTextObserver: new IntersectionObserver(
      (entries) => {
      ...
      { threshold: 0.1, 
        rootMargin: "0px 0px -50% 0px" // This will trigger when the element is halfway into the viewport
      }
    ),
  };
  ...
  const heroTextElements = document.querySelectorAll('.fade-in-section');
  heroTextElements.forEach(elem => observers.heroTextObserver.observe(elem));
    // Carousel observer
    ...
    return () => {
      ...
      heroTextElements.forEach(elem => observers.heroTextObserver.unobserve(elem));
...
<div className="h-m-nav flex flex-col items-center justify-center pt-20 pb-10">
...
<div className="h-m-nav w-full font-normal flex flex-col items-center text-center">
      {width < 640 ? (
        ...
        <>
          ...
          <div className="absolute h-[4rem] bg-black top-0 z-10 left-0 right-0" />
          <div id="animation" ref={heroRef.current} className="v-h-m-n relative z-10 w-screen -mt-16 style={{ height: '100vh' }">
            <div className="w-screen overflow-hidden h-[100vh] absolute bg-white" />
            <video
              id="hero-video"
              ref={videoRef}
              className="h-full w-full object-cover brightness-[.3] transition-all duration-300"
              style={{
                position: 'absolute',
                top: 0,
                left: 0,
              ...
              src={heroVideo}
/>
            <div className="absolute top-0 pt-20 flex flex-col justify-center w-full items-center" style={{ gap: '4rem' }}>
                <div className="fade-in-section opacity-0 translate-y-10 transition-all duration-1000 ease-out">
                  <p className="text-5xl font-medium text-bold text-white z-10" style={{ maxWidth: '75rem', margin: '0 auto', padding: '0 4rem' }}>
                    Teleporter streams its surroundings as a live and interactive 3D space.
                  </p>
                </div>
                <div className="fade-in-section opacity-0 translate-y-10 transition-all duration-1000 ease-out">
                  <p className="text-5xl font-medium text-bold text-white z-7" style={{ maxWidth: '75rem', margin: '0 auto', padding: '0 4rem' }}>
                    So you can work, play and experience as if you were physically there.
                  </p>
                </div>
                <div className="fade-in-section opacity-0 translate-y-10 transition-all duration-1000 ease-out">
                  <p className="text-5xl font-medium text-bold text-white z-10" style={{ maxWidth: '75rem', margin: '0 auto', padding: '0 4rem' }}>
                    The biggest breakthrough in communication technology since the video call.
                  </p>
                </div>
              </div>
...
<div className="relative w-full z-10">
  ...
  ></iframe>
      ...
      <p className="med-40 mt-40 sm:mx-20 max-w-[25rem]">The magic is in the software</p>
      <ButtonPlusArrow
        onClick={() => {
          navigate('/software');
          window.scrollTo(0, 0);
        ...
        style="mb-30"
        text={width < 1024 ? 'Learn more' : 'Read about our software'}
      />
    <p className="med-40 mt-40 sm:mx-20 max-w-[25rem]"> As seen in</p>
    <div className="flex flex-row pt-0">
      <div className="w-full max-w-[300px] pt-5">
        <Img 
        alt="." 
        ...
        <div className="w-full max-w-[300px] pb-20">
        <Img 
        alt="." 
        className="w-full h-auto object-cover" 
        src={[awe]} 
        ...
        <div className="w-full max-w-[300px] pt-10">
        <Img 
        alt="." 
        className="w-full h-auto object-cover" 
        src={[breakthrough]} 
